...
export function HeaderMenu({
  ...
  const scrollBottomPad = bottomSafePadding(insets.bottom, spacing.lg)
  const panelWidth = Math.min(windowWidth * 0.88, 340)
  const panelTop = insets.top
  const panelHeight = windowHeight - panelTop - Math.max(insets.bottom, 0)
        ...
        >
          <View style={styles.panel}>
            <ScrollView
              ...
              contentContainerStyle={[styles.menuScrollContent, { paddingBottom: scrollBottomPad }]}
